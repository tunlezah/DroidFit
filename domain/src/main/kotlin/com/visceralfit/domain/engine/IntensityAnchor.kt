...
enum class IntensityAnchor(val id: String) {
    ...
    companion object {
        ...
        private val ENTRIES: List<Anchored> = listOf(
            ...
            Anchored(Modality.MAT_PILATES, 1.8, RECOVERY),
            Anchored(Modality.MAT_PILATES, 2.3, RECOVERY),
            Anchored(Modality.MAT_PILATES, 2.8, RECOVERY),
            Anchored(Modality.MAT_PILATES, 3.8, ZONE_2),
